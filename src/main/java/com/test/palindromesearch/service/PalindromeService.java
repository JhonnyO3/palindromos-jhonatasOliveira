...
public class PalindromeService {
    ...
    public List<PalindromeDTO> getAllPalindromes(Long id) {
        ...
        try {
            if (id != null) {
                ...
                palindromes.add(palindrome.get());

            } else{
                palindromes = palindromeRepository.findAll();
            }
            if (palindromes.isEmpty()) {
                throw new PalindromeException(HttpStatus.NOT_FOUND, "Not found any palindrome");
            }
            List<PalindromeDTO> palindromeDTOList = palindromeDTOMapper.mapToDTOList(palindromes);
    ...
    public List<PalindromeDTO> findPalindromeInMatriz(MatrizDTO matrizDto) throws Exception {
        try {
            ...
            palindromeDTOList = getAllPalindromes(null);
